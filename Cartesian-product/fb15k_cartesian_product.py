...
def cartesian_performance(rid, gt):
    ...
    if np.nonzero(inpo_test[rid])[1].any():
        ...
        print '{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(rel,
                                                                            round(float(rank) / (2 * len(test_pairs)),
                                                                                  2),
                                                                            round(float(hit10) / (2 * len(test_pairs)),
                                                                                  2) * 100,
                                                                            round(float(hit1) / (2 * len(test_pairs)),
                                                                                  2) * 100,
                                                                            round(float(mrr) / (2 * len(test_pairs)),
                                                                                  2),
                                                                            round(float(frank) / (2 * len(test_pairs)),
                                                                                  2),
                                                                            round(float(fhit10) / (2 * len(test_pairs)),
                                                                                  2) * 100,
                                                                            round(float(fhit1) / (2 * len(test_pairs)),
                                                                                  2) * 100,
                                                                            round(float(fmrr) / (2 * len(test_pairs)),
                                                                                  2),
                                                                            round(
                                                                                float(frank_gt) / (2 * len(test_pairs)),
                                                                                2),
                                                                            round(float(fhit10_gt) / (
                                                                                    2 * len(test_pairs)), 2) * 100,
                                                                            round(
                                                                                float(fhit1_gt) / (2 * len(test_pairs)),
                                                                                2) * 100,
                                                                            round(
                                                                                float(fmrr_gt) / (2 * len(test_pairs)),
                                                                                2))


find_all_cartesian_rels()
