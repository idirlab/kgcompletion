...
#bash run.sh train RotatE wn18 2 0 512 1024 500 12.0 0.5 0.0001 80000 8 -de
#bash run.sh train RotatE wn18rr 2 0 512 1024 500 6.0 0.5 0.00005 80000 8 -de
...
#bash run.sh train RotatE YAGO3-10 2 0 1024 400 500 24.0 1.0 0.0002 100000 4 -de
#
