...
from evaluation import ranking_and_hits2
...
#Config.batch_size = 19 #set to 19 during test
...
def main():
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if epoch==999:
                    ranking_and_hits2(model,test_rank_batcher,vocab,'test_evaluation_final')
